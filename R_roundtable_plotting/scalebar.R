# additing additional options to map.scale function
# we need to set line width and color
                       ...
                       ...) 
{
  ...
  lines(linexy, ...) # I just added '...' here to allow specification of additional plotting parameters
